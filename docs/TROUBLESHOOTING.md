# Troubleshooting — IT-Stack NEXTCLOUD
...
```bash
# Test connectivity
psql -h lab-db1 -U nextcloud_user -d nextcloud_db -c '\conninfo'
...
1. Check resource usage: docker stats it-stack-nextcloud
...
| Log | Path |
|-----|------|
| Application | docker compose logs nextcloud |
